...
export default async function HomePage() {
  ...
  return (
    <>
        ...
        <Container maxWidth="lg" className="relative z-10">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center md:text-left space-y-6">
              ...
              {/* Stats */}
              <div className="flex flex-wrap gap-6 sm:gap-8 justify-center md:justify-start pt-8 text-center md:text-left">
                <div>
                  <div className="text-2xl sm:text-3xl font-bold text-gray-900">500+</div>
                  <div className="text-xs sm:text-sm text-gray-600">Défis créés</div>
                </div>
                <div>
                  <div className="text-2xl sm:text-3xl font-bold text-gray-900">10k+</div>
                  <div className="text-xs sm:text-sm text-gray-600">Activités trackées</div>
                </div>
                <div>
                  <div className="text-2xl sm:text-3xl font-bold text-gray-900">1M+</div>
                  <div className="text-xs sm:text-sm text-gray-600">Kilomètres parcourus</div>
                </div>
              </div>
            </div>
      ...
      <div className="relative py-12 sm:py-16 md:py-24 bg-gradient-to-br from-blue-50/20 via-white to-orange-50/30 overflow-hidden">
        {/* Background decoration */}
